...
describe('Test: logger', function () {
    ...
    describe('Test: printDatabase', function () {
    ...
    describe('Test: startDropDatabase', function () {
    ...
    describe('Test: stopDropDatabase', function () {
    ...
    describe('Test: startDropCollection', function () {
    ...
    describe('Test: stopDropCollection', function () {
    ...
    describe('Test: startEmptyCollection', function () {
    ...
    describe('Test: stopEmptyCollection', function () {
    ...
    describe('Test: stopAndClear', function () {
